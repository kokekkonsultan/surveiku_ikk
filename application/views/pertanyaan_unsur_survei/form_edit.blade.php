                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10 col-form-label">
                            ...
                            <div class="mt-3 mb-5" id="inputan" <?php echo $pertanyaan->is_active_alasan == 1 ? "" : "style='display: none;'" ?>>
                                <input class="form-control" name="label_alasan" id="label_alasan" placeholder="Silahkan isi label jika ditampilkan alasan ..." value="{{$pertanyaan->label_alasan}}">
