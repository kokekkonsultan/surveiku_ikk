					...
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						<div class="d-flex flex-center mb-15">
							<a href="<?php echo e(base_url()); ?>">
								<img src="<?php echo e(base_url()); ?>assets/img/site/logo/logo-letter.png" class="max-h-75px" alt="" />
							</a>
						</div>
...
</html><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/include_backend/template_auth.blade.php ENDPATH**/ ?>