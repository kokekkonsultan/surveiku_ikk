    ...
    <div class="row mt-5">
        ...
        <div class="col-md-9">
            ...
            <div class="card mb-5" data-aos="fade-down">
                ...
                <?php if($profiles->is_dimensi = 1 && $pertanyaan_unsur == 100 && $sektor > 0 && $wilayah_survei > 0 &&
                        ...
                        <div class="col-xl-8">
                            <div class="my-5">
                                ...
                                <div class="text-center">
                                    ...
                                    <!-- <?php echo anchor(base_url().$ci->session->userdata('username').'/'.$ci->uri->segment(2).'/link-survey/update-link',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/link_survei/index.blade.php ENDPATH**/ ?>