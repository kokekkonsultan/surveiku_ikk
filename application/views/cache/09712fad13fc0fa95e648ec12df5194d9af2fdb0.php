            ...
            <div
                ...
                <div class="navi-item my-2 btn-group dropright">
                    ...
                    <div class="dropdown-menu" x-placement="right-start">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e($ci->uri->segment(3) == 'tahapan-pembelian' ? 'active' : ''); ?>"
                                href="<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/tahapan-pembelian">Tahapan
                                Pembelian</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link <?php echo e($ci->uri->segment(3) == 'dimensi' ? 'active' : ''); ?>"
                                href="<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/dimensi">Dimensi</a>
                        </li>


                        <li class="nav-item">
                            <a class="nav-link <?php echo e($ci->uri->segment(3) == 'pertanyaan-unsur' ? 'active' : ''); ?>"
                ...
                <div class="navi-item my-2 btn-group dropright">
                    <a class="navi-link <?php echo e($ci->uri->segment(3) == 'rekap-alasan' || $ci->uri->segment(3) == 'rekap-saran' ? 'active' : ''); ?> dropdown-toggle"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="navi-icon mr-4">
                            <span class="svg-icon svg-icon-lg">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                    ...
                    <div class="dropdown-menu" x-placement="right-start">
                        ...
                        <li><a href="<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/rekap-alasan"
                                class="font-weight-bold nav-link <?php if($ci->uri->segment(3) == 'rekap-alasan'): ?> active <?php endif; ?>">Rekap
                                Alasan Jawaban</a>
                        </li>


                        <?php if($is_saran == 1): ?>
                        <li><a href="<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/<?php echo e($ci->uri->segment(2)); ?>/rekap-saran"
                                class="font-weight-bold nav-link <?php if($ci->uri->segment(3) == 'rekap-saran'): ?> active <?php endif; ?>">Rekap
                                Saran</a>
                        </li>
                        <?php endif; ?>
...
</div><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/manage_survey/menu_data_survey.blade.php ENDPATH**/ ?>