...
<link href="<?php echo e(base_url()); ?>assets/themes/metronic/assets/plugins/custom/datatables/datatables.bundle.css"
...
<div class="container-fluid">
    ...
    <div class="card card-custom card-stretch-half gutter-b overflow-hidden mb-5">
                <div class="card-body d-flex p-0">
                    <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                        style="background-color: #093663; background-position: right bottom; background-size: 100% auto; background-image: url(<?php echo e(base_url() . '/assets/img/banner/taieri.svg'); ?>)">
    ...
    <?php if($ci->ion_auth->in_group('supervisor')): ?>
    <span class="mb-5">
        <div id="dashboard-chart-spv">
            <div align="center">
                <img src="<?php echo e(base_url()); ?>assets/img/ajax/preloader.gif" alt="" width="80px">
            </div>
        </div>
...
$(function() {
    $.ajax({
        type: "GET",
        url: "<?php echo e(base_url()); ?><?php echo e($ci->session->userdata('username')); ?>/dashboard-chart-online",
        dataType: "html",
        success: function(response) {
            $("#dashboard-chart-spv").html(response);
        },
        // error: function(data) {
        //     alert("Error Request Found");
        // }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/dashboard/index.blade.php ENDPATH**/ ?>