...
<div class="container-fluid">
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-9">
            ...
            <?php if($manage_survey->organisasi == '' || $manage_survey->description == '' || $manage_survey->alamat == '' ||
            ...
            <div class="card card-custom bgi-no-repeat gutter-b" style="height: 150px; background-color: #1c2840; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(/assets/img/banner/rhone-2.svg)" data-aos="fade-down">
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <?php if($manage_survey->organisasi == '' || $manage_survey->description == '' ||
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1">
                                        <div class="text-dark text-hover-success font-size-h5 font-weight-bold mb-1">
                                            <?php echo e($profiles->survey_name); ?>
                                ...
                                <div class="d-flex flex-wrap align-items-center py-2">
                                    <div class="d-flex align-items-center">
                                        <div class="mr-6">
                                            ...
                                            <span class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold"><?php echo e(date("d M Y", strtotime($profiles->survey_start))); ?></span>
                                        </div>
                                        <div class="mr-6">
                                            <div class="font-weight-bold mb-2">Survei Berakhir</div>
                                            <span class="btn btn-sm btn-text btn-light-danger text-uppercase font-weight-bold"><?php echo e(date("d M Y", strtotime($profiles->survey_end))); ?></span>
                                        </div>

                                        <div class="mr-6">
                                            <div class="font-weight-bold mb-2">Klasifikasi Survei</div>
                                            <span class="btn btn-sm btn-text btn-light-info text-uppercase font-weight-bold"><?php echo e($profiles->nama_klasifikasi_survey); ?></span>
                                        </div>

                                        <div class="mr-6">
                                            <div class="font-weight-bold mb-2">Kelompok Skala</div>
                                            <span class="btn btn-sm btn-text btn-light-success text-uppercase font-weight-bold"><?php echo e($manage_survey->nama_kelompok_skala); ?></span>
                                        </div>

                                        <div class="mr-6">
                                            <div class="font-weight-bold mb-2">Wilayah Survei</div>
                                            <span class="btn btn-sm btn-text btn-light text-uppercase font-weight-bold"><?php echo e($wilayah_survei); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                                ...
                                <span class="text-primary font-weight-bolder font-size-h5">
                                    <span class="text-dark-50 font-weight-bold"></span><?php echo e($profiles->nama_sampling); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                                ...
                                <span class="text-primary font-weight-bolder font-size-h5">
                                    <span class="text-dark-50 font-weight-bold"></span><?php echo e($profiles->jumlah_populasi); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div class="d-flex flex-column text-dark-75">
                                ...
                                <span class="text-primary font-weight-bolder font-size-h5">
                                    <span class="text-dark-50 font-weight-bold"></span><?php echo e($profiles->jumlah_sampling); ?></span>
                            </div>
                        </div>
                ...
                <div class="d-flex align-items-center">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="text-info font-weight-bolder font-size-h5">
                                <span class="font-weight-bolder">
                                    <?php echo e($manage_survey->view_visitor - ($di_data_responden + $di_pertanyaan + $di_saran + $finish)); ?>
                    ...
                    <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="text-info font-weight-bolder font-size-h5">
                                <span class="font-weight-bolder"><?php echo e($di_data_responden); ?></span></span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                        <span class="mr-4">
                        ...
                        <div class="d-flex flex-column">
                            <span class="text-dark-75 font-weight-bolder font-size-sm">Berhenti di Pertanyaan
                                Unsur</span>
                            <span class="text-info font-weight-bolder font-size-h5">
                                <span class="font-weight-bolder"><?php echo e($di_pertanyaan); ?></span></span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                        <span class="mr-4">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="text-info font-weight-bolder font-size-h5">
                                <span class="font-weight-bolder"><?php echo e($di_saran); ?></span></span>
                        </div>
                    </div>
                    <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                        <span class="mr-4">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span class="text-info font-weight-bolder font-size-h5">
                                <span class="font-weight-bolder"><?php echo e($finish); ?></span></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form action="<?php echo base_url() . $ci->uri->segment(1) . '/' . $ci->uri->segment(2) . '/update-repository' ?>" class="form_pembuka">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <?php echo e($manage_survey->organisasi); ?>
                        ...
                        <div class="form-group row" class="krejcie" id="krejcie" <?php echo $manage_survey->id_sampling == 1 ? '' : 'hidden' ?>>
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="text" id="populasi_krejcie" name="populasi_krejcie" class="form-control" placeholder="10000" value="<?php echo e($manage_survey->id_sampling == 1 ? $manage_survey->jumlah_populasi : ''); ?>">
                            </div>
                            <div class="col-sm-5">
                                <label class="col-form-label font-weight-bold">Jumlah Minimal Sampling
                                    <span class="text-danger">*</span></label>
                                <input type="text" id="total_krejcie" name="total_krejcie" class="form-control" placeholder="370" style="background-color: #F3F6F9;" value="<?php echo e($manage_survey->id_sampling == 1 ? $manage_survey->jumlah_sampling : ''); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" class="slovin" id="slovin" <?php echo $manage_survey->id_sampling == 2 ? '' : 'hidden' ?>>
                            ...
                            <div class="col-sm-5">
                                <label class="col-form-label font-weight-bold">Jumlah Populasi <span class="text-danger">*</span></label>
                                <input type="text" id="populasi_slovin" name="populasi_slovin" class="form-control" placeholder="10000" value="<?php echo e($manage_survey->id_sampling == 2 ? $manage_survey->jumlah_populasi : ''); ?>">
                            </div>
                            <div class=" col-sm-5">
                                <label class="col-form-label font-weight-bold">Jumlah Minimal Sampling <span class="text-danger">*</span></label>
                                <input type="text" id="total_slovin" name="total_slovin" class="form-control" placeholder="385" style="background-color: #F3F6F9;" value="<?php echo e($manage_survey->id_sampling == 2 ? $manage_survey->jumlah_sampling : ''); ?>" readonly>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/manage_survey/form_repository.blade.php ENDPATH**/ ?>