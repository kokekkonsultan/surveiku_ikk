                ...
                <div class="row">
                    <div class="col-md-6">
                        <p>
                            ...
                            <span class="font-weight-bold"><?php echo e($data_langganan->nama_paket); ?></span>
                        </p>

                        <p>
                            <label>Deskripsi</label><br>
                            <span class="font-weight-bold"><?php echo $data_langganan->deskripsi_paket; ?></span>
                        </p>

                        <p>
                            <label>Lama Berlangganan</label><br>
                            <span class="font-weight-bold"><?php echo e($data_langganan->panjang_hari); ?> Hari</span>
                        </p>

                        <p>
                            <label>Harga Paket</label><br>
                            <span class="font-weight-bold"><?php echo e($data_langganan->harga_paket); ?></span>
                        </p>

                        <p>
                            <label>Tanggal Pembelian</label><br>
                            <span
                                class="font-weight-bold"><?php echo e(date('d-m-Y', strtotime($data_langganan->tanggal_mulai))); ?></span>
                        </p>
                    ...
                    <div class="col-md-6">
                        <p>
                            ...
                            <span class="font-weight-bold"><?php echo e($data_langganan->jumlah_user); ?></span>
                        </p>

                        <p>
                            <label>Jumlah Kuesioner</label><br>
                            <span class="font-weight-bold"><?php echo e($data_langganan->jumlah_kuesioner); ?></span>
                        </p>

                        <p>
                            <label>Status Paket</label><br>
                            <span><?php echo $status_paket; ?></span>
                        </p>

                        <p>
                            <label>Tanggal Jatuh Tempo</label><br>
                            <span class="font-weight-bold text-danger"><?php echo $status_jatuh_tempo; ?></span>
                        </p>
...
<?php echo $__env->make("users_management/form_modal_divisi", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/users_management/list_users_management.blade.php ENDPATH**/ ?>