...
$status = '<a href="#" title="Klik untuk mengubah privasi"><span class="badge badge-success">Public</span></a>';
$color = 'primary';
} else {
$status = '<a href="#" title="Klik untuk mengubah privasi"><span class="badge badge-danger">Private</span></a>';
$color = 'primary';
};
...
<div class="card card-custom wave wave-animate-slow" data-aos="fade-down">
    ...
    <div class="card-body">
        ...
        <?php echo $icon . '  ' . anchor(base_url() . $ci->uri->segment(1) . '/kelola-survei', $ci->uri->segment(1), ['class' =>
...
</div> --><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/include_backend/partials_no_aside/_inc_menu_repository.blade.php ENDPATH**/ ?>