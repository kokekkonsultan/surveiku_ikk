...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <?php if($total_persentase == 100): ?>
            <div class="card card-body shadow mt-5 <?php echo e($color); ?>" data-aos="fade-down" data-aos-delay="300">
            ...
            <?php elseif($total_persentase > 100): ?>
    ...
    $.ajax({
        ...
        complete: function() {
            ...
            $('.tombolKonfirmasi').html(
                '<i class="fas fa-check-circle <?php echo e($text_color); ?>"></i> Konfirmasi');
        },
        error: function(e) {
            Swal.fire(
                'Error !',
...
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/dimensi_survei/index.blade.php ENDPATH**/ ?>