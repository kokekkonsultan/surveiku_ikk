...
<body id="kt_body"
    ...
    <!-- <a class="sticky-chat-button shadow" data-toggle="tooltip" data-placement="right" title="Edit Form Survei"
        href="<?php echo e(base_url().$ci->uri->segment(1).'/'.$ci->uri->segment(2).'/edit-form-survei/opening'); ?>" target="_blank">
        <span>
...
</html><?php /**PATH C:\xampp-7.3.33\htdocs\surveiku_ikk\application\views/include_backend/_template.blade.php ENDPATH**/ ?>