...
<html lang="en">
	<head>
		...
		<link href="{{ TEMPLATE_BACKEND_PATH }}css/pages/login/classic/login-4.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		<div class="d-flex flex-column flex-root">
			<div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('{{ TEMPLATE_BACKEND_PATH }}media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						<div class="d-flex flex-center mb-15">
							<a href="{{ base_url() }}">
								<img src="{{ base_url() }}assets/img/site/logo/logo-letter.png" class="max-h-75px" alt="" />
							</a>
						</div>
		...
		<script src="{{ TEMPLATE_BACKEND_PATH }}js/pages/custom/login/login-general.js"></script>
		@yield('javascript')
	</body>
</html>