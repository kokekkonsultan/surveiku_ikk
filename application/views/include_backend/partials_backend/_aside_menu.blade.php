...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}kelompok-skala" class="menu-link">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}tahapan-pembelian" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}dimensi" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}unsur" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}pertanyaan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}inject-pertanyaan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}lokasi-survei" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
            ...
            @if ($ci->ion_auth->in_group($group))
            @php
            $menu_master = ['overview', 'kelola-survei'];
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @php
                        ($ci->uri->segment(2) == 'kelola-survei') ? $child_menu_active = 'menu-item-active' :
                        $child_menu_active = '';
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @php
                        ($ci->uri->segment(2) == 'target-surveyor') ? $child_menu_active = 'menu-item-active' :
                        $child_menu_active = '';
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="<?php echo base_url() . $ci->session->userdata('username') . '/target-surveyor' ?>"
                                class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Target Surveyor</span>
                            </a>
                        </li>
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}target-keseluruhan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Keseluruhan</span>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}target-per-bagian" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Per Bagian</span>
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}nilai-index-keseluruhan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Keseluruhan</span>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}nilai-index-bagian" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                                <span class="menu-text">Per Bagian</span>
