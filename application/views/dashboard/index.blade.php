...
@section('style')
<link href="{{ base_url() }}assets/themes/metronic/assets/plugins/custom/datatables/datatables.bundle.css"
...
<div class="container-fluid">
    ...
    <div class="card card-custom card-stretch-half gutter-b overflow-hidden mb-5">
                <div class="card-body d-flex p-0">
                    <div class="flex-grow-1 p-12 card-rounded bgi-no-repeat d-flex flex-column justify-content-center align-items-start"
                        style="background-color: #093663; background-position: right bottom; background-size: 100% auto; background-image: url({{base_url() . '/assets/img/banner/taieri.svg'}})">
    ...
    @if ($ci->ion_auth->in_group('supervisor'))
    <span class="mb-5">
...
$(function() {
    $.ajax({
        type: "GET",
        url: "{{ base_url() }}{{ $ci->session->userdata('username') }}/dashboard-chart-online",
        dataType: "html",
        success: function(response) {
